...
enum class Variable(val value: String, val description: String) {
    ...
    NAME_ALL_LOWER_CASE("%screenNameAllLowerCase%", "Name of the screen written completely in lower case, e.g. screenname"),
    ...
    PATH_TO_BINDING("%bindingPath%", "Android path to auto-generated view/data binding files")
}